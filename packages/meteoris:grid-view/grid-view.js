 ...
 */
UI.registerHelper('meteoris_gridView', function(option, firstParam) {
    return Meteoris.GridView[option](firstParam);
});
UI.registerHelper('meteoris_gridViewSortClass', function(by) {
    return Meteoris.GridView.sortClass(by);
});