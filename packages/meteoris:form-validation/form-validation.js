Namespace('Meteoris.FormValidation');

Meteoris.FormValidation = {
...
UI.registerHelper('meteoris_formValidationError', function(collections, field) {
    return Meteoris.FormValidation.error(collections, field)
});
